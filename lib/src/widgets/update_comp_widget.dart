...
class UpdateCompetition extends StatefulWidget {
  const UpdateCompetition({super.key});

  @override
  State<UpdateCompetition> createState() => _UpdateCompetitionState();
}

class _UpdateCompetitionState extends State<UpdateCompetition> {
