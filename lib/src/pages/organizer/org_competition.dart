...
class DetailMyComp extends StatefulWidget {
  const DetailMyComp({super.key});

  @override
  State<DetailMyComp> createState() => _DetailMyCompState();
}

class _DetailMyCompState extends State<DetailMyComp> {
  int currentIndex = 0;
  @override
